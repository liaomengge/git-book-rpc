1. 该篇要说日志链路追踪不是值得各种服务之前调用的一个完整的链路，比如：zipkin等，当然，Spring Cloud都集成了，这篇只是想描述下对于服务端，如何快速定位服务中的问题（在重构中，尤其跨部门之前的调用，经常遇到一些问题，然后，就是各种“甩锅”），那么，这篇将处理，如何在服务端快速定位问题。当然，如果集成那种完整的链路调用，也是可以的，我这篇的初衷是怎么轻量的处理这种问题~
